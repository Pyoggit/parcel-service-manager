...
public class CustomerRegisterManager {
	...
	public void sortManager() {
	    CustomerDAO custdao = new CustomerDAO();
	    ArrayList<CustomerVO> customerList = custdao.customerSortedSelect();
	...
	public void printCustomerList(ArrayList<CustomerVO> customerList) {
		System.out.println("===================================================================================================");
		System.out.printf("%-10s %-10s %-12s %-15s %-12s %-20s %-12s%n", "회원코드", "이름", "ID", "전화번호", "생년월일", "이메일",
				"가입일자");
		System.out.println("===================================================================================================");
		for (CustomerVO cv : customerList) {
			System.out.printf("%-10s %-10s %-12s %-15s %-12s %-20s %-12s%n", cv.getCode(), cv.getName(), cv.getId(),
					cv.getPhone(), cv.getBirth(), cv.getEmail(), cv.getCdate());
		}
		System.out.println("===================================================================================================");
	}
